...
$description = "Search Results for " . $search_term . " the IT-Blog";

// SQL for the search term
...
<main class="container mx-auto">
    <section class="flex flex-col justify-center items-center p-10">
        ...
        <form action="search.php" method="get" class="mt-4">
            ...
            <input type="search" name="search" id="search" value="<?= $search_term ?>" class="border p-2">
